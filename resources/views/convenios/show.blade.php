...
@section('title',__($convenio->id . ': CRUD Laravel'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        <span><span class="text-info">{{$convenio->id}}</span>: (@lang('CRUD Laravel'))</span>
                ...
                <div class="card-body">
                    ...
                    <table class="w3-table-all notranslate" width="100%" border="1">
                        ...
                        <tr>
                            ...
                            <th align="left">{{$convenio->fone_cov}}</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th align="left"><strong>@lang('--:')</strong>:</th>
