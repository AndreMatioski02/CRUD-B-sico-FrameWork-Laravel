            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text("paciente_id", $pacientes, $consulta->paciente_id, ["class"=>"form-control","required"=>"required"]) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label(__('Nome do Médico:')) !!}
                        {!! Form::text("medico_id", $medicos, $consulta->medico_id, ["class"=>"form-control","required"=>"required"]) !!}
                    </div>
